...
export class GlobalizationMessagesService {
  ...
  get(key: string): Observable<HttpResponse<any>> {
    return this.httpClient.get(
      this.appSettingsService.apiUrl + '/GlobalizationMessages/Get?key=' + key,
      { observe: 'response' }
    );
  }
  ...
  getByParameter(key: string, parameter: string): Observable<HttpResponse<any>> {
    return this.httpClient.get(
      this.appSettingsService.apiUrl + '/GlobalizationMessages/GetByParameter?key=' + key + '&parameter=' + parameter,
      { observe: 'response' }
    );
  }
  getByParameter2(key: string, parameter1: string, parameter2: string): Observable<HttpResponse<any>> {
    return this.httpClient.get(
      ...
      + '/GlobalizationMessages/GetByParameter2?key=' + key + '&parameter1=' + parameter1 + '&parameter2=' + parameter2,
      { observe: 'response' }
    );
  }
