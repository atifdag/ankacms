...
import { GlobalizationMessagesService } from '../globalization-messages.service';
    ...
    transform(key: string): string {
        ...
        if (localStorage.getItem(keyPrefix + key) != null) {
            ...
            if (key.indexOf(',') > 0) {
                ...
                if (params.length > 2) {
                    this.service.getByParameter2(params[0], params[1], params[2]).subscribe(
                        o => {
                    ...
                    this.service.getByParameter(params[0], params[1]).subscribe(
                        o => {
                            this.value = o.body as string;
                            localStorage.setItem(keyPrefix + key, this.value);
                        }
